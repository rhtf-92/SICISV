...
import { createEntry, getEntries, getEntryById, getUnsettledEntries, processLicensePlateOCR } from '../controllers/entryController';
...
router.post('/ocr', authenticate, authorize(['admin', 'guard']), processLicensePlateOCR);
